# Academic Arsenal with AI Widget

This folder is a copy of the **Academic Arsenal** app (Math, English, and Science materials) with an optional **AI (Josiah) chat widget** on the side.
...
2. Open your browser to Academic Arsenal with the AI already connected.
