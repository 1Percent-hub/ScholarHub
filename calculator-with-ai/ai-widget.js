(function () {
  ...
  function appendMessage(text, type) {
    ...
    var label = type === "user" ? "You" : "Creater";
    wrap.innerHTML =
  ...
  function appendThinking() {
    ...
    wrap.innerHTML =
      '<div class="ai-widget-msg-label">Creater</div>' +
  ...
  function sendMessage() {
    ...
    fetch(API_URL, {
      ...
      .catch(function () {
        replaceThinkingWithReply(thinkingEl, "Can't reach the server. Make sure the backend is running so the widget can connect.", true, null, null);
      })
      .finally(function () {
        setSendEnabled(true);
      });
  ...
  appendMessage("Hey I'm Creater, what can I do for you?", "bot");
})();
